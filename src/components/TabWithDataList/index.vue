...
<view class="">
  <view class="tab-list-header" v-if="showTab">
    <u-tabs :list="tabs" :is-scroll="false" active-color="#6A88F3" inactive-color="#999999"
            :current="current" @change="tabChange"></u-tabs>
  </view>
  <divider v-show="showTab" />
  <view class="tab-list-content">
    <view class="flex justify-between items-center list-item" v-for="item in listData"
